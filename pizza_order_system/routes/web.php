...
Route::middleware(['auth'])->group(function(){
    ...
    Route::middleware(['admin_auth'])->group(function(){
        ...
        Route::prefix('admin')->group(function(){
            ...
            Route::get('/message/info',[AdminController::class,'messageInfo'])->name('admin#messageInfo');
        ...
        Route::prefix('products')->group(function(){
         ...
         Route::prefix('orders')->group(function(){
            ...
            Route::prefix('user')->group(function(){
                ...
                Route::get('admin/changeRole',[UserController::class,'adminChangeRole'])->name('ajax#adminChangeRole');
               });
    ...
    Route::group(['prefix'=>'user','middleware' => 'user_auth'],function(){
        Route::get('/userHome',[UserController::class,'home'])->name('user#home');
        Route::get('/filter/{id}',[UserController::class,'filter'])->name('user#filter');
        Route::get('/history',[UserController::class,'history'])->name('user#history');
        Route::get('/contact/toAdmin',[UserController::class,'contactToAdmin'])->name('user#contactToAdmin');
