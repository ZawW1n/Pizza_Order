                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('product#create')}}" enctype="multipart/form-data" method="post" novalidate="novalidate">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="pizzaDescription" class="form-control @error('pizzaDescription') is-invalid @enderror " value id="" cols="30" rows="10" placeholder="Enter Pizza Description...">{{old('pizzaDescription')}}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="cc-pament" name="pizzaWaitingTime" value="{{ old('pizzaWaitingTime')}}" type="text" class="form-control @error('pizzaWaitingTime') is-invalid @enderror" aria-required="true" aria-invalid="false" placeholder="Enter Pizza Waiting Time...">
