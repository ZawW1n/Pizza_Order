                ...
                <table class="table table-light table-borderless table-hover text-center mb-0" id="dataTable">
                    ...
                    <tbody class="align-middle">
                       @foreach ($cartList as $c)
                            <tr>
                                <td><img src="{{ asset('storage/'. $c->product_image)}}" alt="" class="img-thumbnail shadow-sm" width="100px"></td>
                                <td class="align-middle">{{ $c->pizza_name}}
                                <input type="hidden" class="orderId" value="{{ $c->id}}" id="">
                                <input type="hidden" class="productId" value="{{ $c->product_id}}" id="">
                                <input type="hidden" class="userId" value="{{ $c->user_id}}" id="">
                                </td>
                ...
                <div class="bg-light p-30 mb-5">
                    <div class="border-bottom pb-2">
                        <div class="d-flex justify-content-between mb-3">
                            <h6>Subtotal</h6>
                            <h6 id="subTotalPrice">{{$priceTotal}} Kyats</h6>
                        </div>
                    ...
                    <div class="pt-2">
                        <div class="d-flex justify-content-between mt-2">
                            <h5>Total</h5>
                            <h5 id="finalPriceTotal">{{ $priceTotal+3000 }} Kyats</h5>
                        </div>
                        ...
                        <button class="btn btn-block btn-danger font-weight-bold my-3 py-3" id="clearBtn">
                            <span class="text-dark">Clear Cart</span>
                        </button>
                    </div>
                </div>
            </div>
...
@section('scriptSource')
    ...
    <script>
        ...
        $('#clearBtn').click(function(){
            ...
            $('finalPriceTotal').html("3000 Kyats");
        })

        // clear current products when remove button click
